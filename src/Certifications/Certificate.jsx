...
function Certificate() {
  ...
  return (
    ...
    <div className="proj1" style={{backgroundColor:"#f9f9f9",margin: "40px 145px",padding: "10px 60px",borderRadius:"25px"}}>
    <div className="flex items-center" style={{margin:"10px 10px"}}>
      ...
      <div style={{color:"black",fontSize:"1.5rem"}}> Certifications</div>
    </div>

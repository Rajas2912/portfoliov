...
function Footer() {
  return (
    <footer className="bg-black rounded-lg shadow dark:bg-gray-900 m-4" style={{ width: "100%",margin:"0px" }}>
      <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        ...
        <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">
          © 2025 <a href="https://flowbite.com/" className="hover:underline">CodebyRajas™</a>. All Rights Reserved.
        </span>
      </div>
    </footer>
  );
